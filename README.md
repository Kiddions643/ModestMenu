# The best external Mod Menu available Version 1.0.0 :dollar: (new update released)
...
We offer the  **latest, ever-evolving, version** on our [website](https://www.kiddions-modmenu.com). You can find all the information about the features of the current version 1.0.0, and their functionality in the [Features section](https://www.kiddionsmodestmenu.com/features) of our Website. Further down, you'll find more technical details listed.
